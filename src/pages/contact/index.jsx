...
const Contact = () => {
  ...
  return (
    <div className="text-center flex flex-col items-center mt-[6rem]">
      <motion.div
      ...
      <section className="flex space-x-32 mt-10 w-3/5">
        <motion.div
          initial={motionScaleUp.initial}
          whileInView={motionScaleUp.whileInView}
      ...
      <section className="w-full mt-16">
        ...
        >
          ...
          <div className="mt-8 w-full h-[32rem] flex flex-col items-center justify-center">
      ...
      >
        <section className="bg-transparent px-5 flex flex-row items-start justify-center text-white">
          ...
          <div className="w-1/2 p-5">
            <p className="font-light text-18 text-left text-gray-300 tracking-wider ">
